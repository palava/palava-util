...
/**
 * Tests {@link CountryTwoLetterCodecModule}.
 *
 * @author Oliver Lorenz
 */
public class CountryTwoLetterCodecModuleTest implements UnitProvider<CountryTwoLetterCodecModule> {
    
    @Override
    public CountryTwoLetterCodecModule unit() {
        return new CountryTwoLetterCodecModule();
    }
    ...
    public void injectCodecLocaleString() {
        ...
        Assert.assertEquals("DE", codec.encode(Locale.GERMANY));
    }
    ...
    public void injectBijectionLocaleString() {
        ...
        Assert.assertEquals("DE", languageFunc.apply(Locale.GERMANY));
    }
    ...
    public void injectCodecStringLocale() {
        ...
        Assert.assertEquals(new Locale("", "DE"), codec.encode("DE"));
    }
    ...
    public void injectBijectionStringLocale() {
        ...
        Assert.assertEquals(new Locale("", "DE"), languageFunc.apply("DE"));
    }
